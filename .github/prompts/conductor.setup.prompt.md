...
-   **If Brownfield:**
        ...
        -   **Begin Brownfield Project Initialization Protocol:**
            ...
            -   **2.1 File Size and Relevance Triage:**
                1.  **Respect Ignore Files:** Before scanning any files, you MUST check for the existence of `.gitignore` files. If it exists, you MUST use its patterns to exclude files and directories from your analysis.
...
2.  **Select Code Style Guides:**
    -   List the available style guides from the `templates/code_styleguides/` directory in this workspace (or from a known location).
    ...
    -   **Action:** Create the directory and copy all selected style guide files to `conductor/code_styleguides/`.
